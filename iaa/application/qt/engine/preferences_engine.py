...
from ..dsl import FieldSpec, PreferencesContext
...
class PreferencesEngine:
    ...
    def build_runtime(self, state: PreferencesContext) -> dict[str, Any]:
    ...
    def _build_field_runtime(self, field: FieldSpec, state: PreferencesContext) -> dict[str, Any]:
